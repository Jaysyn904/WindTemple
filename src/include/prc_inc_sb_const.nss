/*
	Constants file for the Spellbook functions
	Linked to via prc_inc_core for wider access
*/
...
// range #2
const int SPELLBOOK_IPRP_FEATS_START2 = 18001;
const int SPELLBOOK_IPRP_FEATS_END2   = 24704;
