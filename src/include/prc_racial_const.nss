...
const int RACIAL_TYPE_DS_ELF               = 999;
const int RACIAL_TYPE_DS_HALFELF           = 999;
const int RACIAL_TYPE_DS_HALFGIANT         = 999;
const int RACIAL_TYPE_DS_HALFLING          = 999;
const int RACIAL_TYPE_MUL                  = 999;
const int RACIAL_TYPE_PTERRAN              = 999;
const int RACIAL_TYPE_THRIKREEN            = 999;
...
const int RACIAL_TYPE_LASHEMOI             = 69;
const int RACIAL_TYPE_TURLEMOI             = 70;
const int RACIAL_TYPE_HADRIMOI             = 71;
